	...
	<%
		...
		for(Patient p :  lptpl ) {
			...
			<tr>
				...
				<td><%= p.getVille() %></td>
				<td>
					<a class="btn btn-secondary btn-sm" href="EditPatientServlet?id=<%= p.getId() %>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
...
<script>
	function supprimer( id ){
		if( confirm("Êtes vous sur ?") ){
			console.log('DeletePatientServlet?id='+id  );
			window.location = 'DeletePatientServlet?id='+id; 
		}
	}
</script>
